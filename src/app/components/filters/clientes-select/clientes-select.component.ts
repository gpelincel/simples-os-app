...
import { IonSearchbar, IonItem, IonRadio, IonRadioGroup, IonList, IonSpinner } from '@ionic/angular/standalone';
import { NgIf } from '@angular/common';

@Component({
  standalone: true,
  imports: [IonSearchbar, IonItem, IonRadio, IonRadioGroup, IonList, IonSpinner, NgIf],
